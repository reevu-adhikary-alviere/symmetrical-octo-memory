...
It leads with **bank payments** (ACH) — Alviere's specialty — with cards available as an option. Because it ships as web components, it drops into any stack (React, Vue, plain HTML) without a framework dependency.
